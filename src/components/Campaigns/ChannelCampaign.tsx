            ...
            const data: CampaignData[] = [
                {
                    ...
                    iconColor: "blue",
                    icon: <FaMobile size={24} color='#095179' />
                },
                {
                    ...
                    lastMonth: "Last Month",
                    iconColor: "green",
                    icon: <HiStatusOnline size={24} color='green' />
...

                {
                    ...
                    lastMonth: "Last Month",
                    iconColor: "orange",
                    icon: <RiUserSettingsFill size={24} color='#c58804' />
                },
                {
                    title: "CDM",
                    amount: "$8,243",
                    ...
                    lastMonth: "Last Month",
                    iconColor: "orange",
                    icon: <CiMoneyBill size={24} color='#c58804' />
                },
            ];
            setCampaigns(data);
        };
